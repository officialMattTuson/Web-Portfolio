...
export const hobbyText =
  'In my leisure time, I find joy and relaxation in a diverse range of hobbies. I love football, you should see my collection of jerseys! ' +
...
export const goalsText =
  "My current career goals are all about building connections and continuously learning.  I'm still at the stage where I want to be growing " +
  'as much as possible in as many ways as possible.  Right now, the destination remains unknown, in terms of what I want to specialize in, there are many ' +
  'pathways I could still take.';
